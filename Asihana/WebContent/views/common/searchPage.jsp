<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String text = (String)request.getAttribute("query");
%>    
...
<style>
        ...
        #travel{
            ...
            border-radius: 10px;
            line-height: 45px;
            background-color: rgba(236, 236, 210, 0.384);
        }
        #community{
            width:100px;
            height: 100%;
        ...
        #travelText{
            border-top: 1px solid rgba(75, 70, 70, 0.692);
        ...
        .travelList{
            border-bottom: 1px solid rgba(75, 70, 70, 0.212);
            width: 100%;
            height: 200px;
    ...
    <div id="searchAll">
        ...
        <div id="travelBox">
            <div class="travelList">
                ...
                <p>엄마와 함께한 여행</p>
                <pre>하핳하하하하ㅏ하하하하하하하하핳</pre>
                <b>작성자 : 곰탱이</b>
            </div>
        </div>
        
        <div id="plusButton1"><button>더보기</button></div>
