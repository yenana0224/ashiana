...
import com.kh.semi.myPage.model.service.MyPlanPageService;
import com.kh.semi.pageInfo.model.vo.PageInfo;
import com.kh.semi.plan.model.vo.PlanMain;

/**
 * Servlet implementation class MyPlanPageController
 */
@WebServlet("/myPlanPage.do")
public class MyPlanPageController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPlanPageController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String select = request.getParameter("select"); //검색조건
		String searchContent = request.getParameter("searchContent"); //검색내용
		...
		if(select != null) {//검색조건값이 있으면
			myPlanList = new MyPlanPageService().planSearch(select, searchContent,userNo, pi);
		} else {//검색조건값이 없으면
			myPlanList = new MyPlanPageService().selectList(userNo,pi);
		}
		...
		dispatcherPath = "views/myPage/myPlanPage.jsp";
